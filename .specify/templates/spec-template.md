...
- **Open questions resolved?** Yes / No — if No, escalate via `/speckit-clarify`
  before proceeding to `/speckit-plan`.
- **Reversibility class** (Principle VII): Reversible / One-way door — if
  one-way door, the plan stage MUST enumerate the protecting gate.
